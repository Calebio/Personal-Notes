...
E.g 
HTTPS HTTP TLS  maps to ingress
Roles maps to single namespace and clusterrole multiple 
Chart and packages maps to helm
Networking nodeport, clusterip maps to services
